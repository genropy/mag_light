...
class View(BaseComponent):
    ...
    def th_struct(self,struct):
        ...
        r.fieldcell('deposito_id', width='10em')
        r.fieldcell('data')
        r.fieldcell('status')
...
class Form(BaseComponent):
    ...
    def th_top_custom(self,top):
        ...
        trasferimento_fields=[dict(name='deposito_id', table='mag_light.deposito', lbl='Deposito', tag='dbselect')] 
        bar.azioni.button('!![it]Genera trasferimento',  
                            action="PUBLISH trasferimento = {movimento_id:movimento_id,deposito_id:deposito_id}", 
                            movimento_id='=#FORM.record.id', deposito_id='=.deposito_id',
