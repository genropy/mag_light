...
class Table(TotalizeTable):
    def config_db(self,pkg):
        ...
        tbl.column('prodotto_id', size='22', name_long='Prodotto', group='_', totalize_key=True).relation('mag_light.prodotto.id',
                                                                ...
                                                                onDelete='cascade')
        tbl.column('deposito_id', size='22', name_long='Deposito', totalize_key=True).relation('mag_light.deposito.id',
                                                                mode='foreignkey',
    ...
    def totalize_realign_sql(self,empty=False):
        ...
        sql = """
            INSERT INTO mag_light.mag_light_giacenza_prodotto_deposito (codekey,prodotto_id,deposito_id,quantita_disponibile,quantita_attesa,_refcount)
